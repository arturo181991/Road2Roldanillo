 ...
 */
public class NavigationDrawerListAdapter extends ArrayAdapter<Categoria> {

    public NavigationDrawerListAdapter(Context context, int resource) {
        super(context, resource);
    }

    public NavigationDrawerListAdapter(Context context, int resource, Categoria[] items) {
